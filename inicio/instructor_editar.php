...
<?php
	...
	//modificar--------------------------------------->
		if($_POST) {
				...
				//TODO:UPDATE ARTICLE
		$sql_update_actividad = 'UPDATE instructor SET rfc_instructor = ?,nombre_instructor = ?,apellido_p = ?,apellido_m = ?,act_complementaria_clave_act = ? WHERE rfc_instructor = ?';
...
<div class="col s12">
                <footer class="page-footer teal lighten-2">
                    <div class="footer-copyright">
                        <div class="container">
                            &copy; 2017 Cristian Alonso Ignacio
                        </div>
 <?php
